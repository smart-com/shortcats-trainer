	...
	function checkShortcat( evt ) {
		...
		if ( counter === keyMax ) {
			...
			for ( var i = 0; i < keyMax; i++ ) {
				yes = ~quiz.indexOf( ide[ hotkeyRand ].shortcat[ i ]);
